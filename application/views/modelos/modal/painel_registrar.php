				...
				<div class="container-fluid">
					<div class="row">
						<form class="form-horizontal" id="registrar-ponto" accept-charset="utf-8">
							...
							<div class="form-group">
								<label for="folga_registrar" class="col-sm-4 control-label" title="Dia de folga">Folga</label>
								<div class="col-sm-4">
									<div class="btn-group btn-group-justified" data-toggle="buttons">
										<label class="btn btn-default">
											<input type="radio" name="folga" value="0" autocomplete="off" id="folga_registrar" required> NÃO
										</label>
										<label class="btn btn-default">
